...
|--------|---------------:|
| LSTM Prediction | 251.35 |
| Naive Prediction | 261.50 |

### Observation
- LSTM Predicted Price: **251.35**
- Naive Forecast Price: **261.50** (last observed closing price)
- Difference: **10.15**
...
![LSTM Forecast](images/Tesla_LSTM_Forecast.png)

### Naive Actual vs Predicted Prices

![Naive Forecast](images/Tesla_Naive_Forecast.png)
## Key Findings
...
### Clone Repository
```bash
https://github.com/ajith2617/Mini-Project-Tesla-Stock-Price-Prediction-LSTM
```
...
### Open:
```bash
Tesla Stock Price Prediction 2010 - 2017.ipynb
```
---
### Skills Demonstrated
